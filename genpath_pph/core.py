...
class GenPathHomology(object):
    ...
    def compute_betti_numbers(self, select_path_ids, adj_matrices, pathways_expressions,
        ...
        """
        Computes persistent path homology (PPH) Betti numbers for control and disease 
        groups for one or more KEGG pathways.
